...
//       dark:shadow-secondary
//     ">
//       <div className="font-bold flex-shrink-0">Logo</div>
      
//       {/* Desktop Navigation */}
//       <div className="hidden md:flex items-center gap-2 flex-nowrap">
//         <div className="flex items-center gap-2 flex-shrink-0">
//           <Link href="/"><Button variant="link" className="px-2">Home</Button></Link>
//           <Link href="/about"><Button variant="link" className="px-2">About</Button></Link>
//           <Link href="/skills"><Button variant="link" className="px-2">Skills</Button></Link>
